...
class S3Handler:
    ...
    def __init__(self, aws_access_key_id, aws_secret_access_key, region_name: str = 'us-east-1'):
...
class BedrockHandler:
    ...
    def __init__(self, client: Any, model_id: str, params: Dict[str, Any], aws_access_key: str, aws_secret_access_key: str):
        self.params = params
        self.model_id = model_id
        self.client = client
        self.is_image_model = "nova-canvas" in model_id
        self.is_video_model = "nova-reel" in model_id
        self.s3_handler = S3Handler(aws_access_key, aws_secret_access_key)
    ...
    def user_message(
        ...
        # Add context + text
        if context:
            new_message["content"].append({"text": context + "\n\nHere is the input:"})
        new_message["content"].append({"text": message})
...
class SESHandler:
    """Handles ses-related operations for the application."""
    ...
    def __init__(self, aws_access_key_id, aws_secret_access_key, region_name: str = 'us-east-1'):
        ...
        self.dummy_emails = ["samtkx28@gmail.com"]
    
    def send_email(self, email_content: dict) -> bool:
        subject = email_content["subject"]
        body_html = email_content["body_html"]

        for recipient in self.dummy_emails:
            try:
                self.client.send_email(
                    Source="hello0101wworld@gmail.com",  # Must be verified in SES
